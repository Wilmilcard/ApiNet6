    ...
    public static class ModelBuilderExtensions
    {
        public static void Seed(this ModelBuilder modelBuilder)
        {
            ...
            var fakerAlquiler = new Bogus.Faker<Alquiler>()
                ...
                .RuleFor(x => x.Valor_Total, f => f.Random.Number(15000, 20000))
                .RuleFor(x => x.CreatedAt, _CreatedAt)
                .RuleFor(x => x.CreatedBy, _CratedBy);
            ...
            #region Juego
            int precio_1 = 25000, precio_2 = 325000;
            ...
            modelBuilder.Entity<Juego>().HasData(
                new Juego
                {
                    ...
                    Precio = random.Next(precio_1, precio_2),
            ...
            var fakerProtagonistaJuego = new Bogus.Faker<ProtagonistaJuego>()
                ...
                .RuleFor(x => x.JuegoId, f => random.Next(1, 50))
                .RuleFor(x => x.ProtagonistaId, f => random.Next(1, 36))
                .RuleFor(x => x.CreatedAt, _CreatedAt)
                .RuleFor(x => x.CreatedBy, _CratedBy);
